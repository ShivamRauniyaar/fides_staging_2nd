...
const Hero9Slide = ({ slide }) => {
  const { title, desc, id, img, imgSrc, tag, price, disc } = slide;
  ...
  return (
    ...
    >
      {/* <div
        className="col-xxl-6 col-xl-7 col-lg-6 col-md-12 col-sm-12 invisible"
        data-aos="fade-up"
        data-aos-duration="1500"
      >
        <div className="herobanner__content__wrapper herobanner__content__wrapper--2 hideen">
      ...
      <div className="col-xxl-6 col-xl-5 col-lg-6 col-md-12 col-sm-12 invisible">
