...
import serviceImage6 from "@/assets/img/service/service__6.png";  //event__about.png
import aboutImmg from "@/assets/img/about/event__about.png"
const Services5 = () => {
          ...
          <div className="col-xl-9 col-lg-9 col-md-9 col-sm-8 col-8">
            <div className="section__title section__title--2  section__title--3">
              ...
              >
                <h3  style={{
                  color: "black",
                }}>We are providing following services available.</h3>
              </div>
            </div>
          </div>
        </div>
