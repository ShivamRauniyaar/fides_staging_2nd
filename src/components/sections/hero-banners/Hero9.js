  ...
  const slides = [
    {
      ...
      imgSrc:
        "http://www.fidesgroup.in/wp-content/uploads/2016/04/BUSINESS-LOAN-1388x578.jpg",
    },
    {
      id: 2,
      title: (
      ...
      imgSrc:
        "http://www.fidesgroup.in/wp-content/uploads/2016/04/CAR-INSURANCE-NEELAM1-1388x578.jpg",
    },
    {
      id: 3,
      title: (
      ...
      imgSrc:
        "http://www.fidesgroup.in/wp-content/uploads/2016/04/GENERAL-INSURANCE-NEELAM-1388x578.jpg",
    },
    {
      id: 4,
      title: (
      ...
      img: herobannerImage2,
      imgSrc:
        "http://www.fidesgroup.in/wp-content/uploads/2016/04/HEALTH-INSURANCE-NEELAM1-1388x578.jpg",
    },
    {
      id: 5,
      title: (
      ...
      img: herobannerImage2,
      imgSrc:
        "http://www.fidesgroup.in/wp-content/uploads/2016/04/HOME-LOAN-1388x578.jpg",
    },
  ];
  return (
    <div
      ...
      style={{
        background: ` url('${herobannerBgImage1.src}')`,
      }}
    >
      <div
        className="container"
